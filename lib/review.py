...
class Review:
    ...
    def year(self, year):
        if isinstance(year, int) and year >= 2000:
            ...
            raise ValueError("Year must be a number and greater than or equal to the year 2000")
    @property 
    def summary(self):
    ...
    def summary(self, summary):
        if isinstance(summary, str) and len(summary):
            ...
            raise ValueError("Summary cannot be zero characters")
    @property
    ...
    def employee_id(self, employee_id):
        if isinstance(employee_id, int) and Employee.find_by_id(employee_id):
            ...
            raise ValueError("Must be proper employee ID")
    @classmethod
